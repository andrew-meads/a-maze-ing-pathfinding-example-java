...
/**
 * This class handles the responsibility of converting a {@link Maze} into a {@link Graph} which can be searched.
 *
 * @author Andrew Meads
 */
public class GraphFactory {
    ...
    /**
     * Creates a {@link Graph}, from a {@link Maze}.
     * <p>
    ...
    public static Graph fromMaze(Maze maze, boolean allowDiagonalMovement) {
        Graph g = new Graph();
        Node[][] nodes = createNodes(maze, g);
        createEdges(g, nodes, allowDiagonalMovement);
        return g;
    }

    /**
     * Creates all {@link Node} instances from the given {@link Maze}. Adds the nodes to the given graph, and returns
     ...
     */
    private static Node[][] createNodes(Maze maze, Graph g) {
